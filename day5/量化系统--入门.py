...
当身在赌局中时，如果没有自己的优势，那么一定处于不利地位，长期的交易一定会输光所有资本
盈利像鲜花，它总不开放，欲望像野草，它疯狂地生长
注意，这两个试了的策略看起啦似乎很美，但是这里的实现只是为了作为入门示例
因为我们的假定前提是知道要买什么股票，并且所有资金都买入这个股票，无风险考虑因素，无设定止损因素，
交易手续费也全部忽略了，真实的策略及系统将在后续一一展开
"""
'#######################################################################################################################'
"""
仓位控制管理
对于量化来说，好的交易策略是投资者的进攻武器，是投资者的矛，而仓位控制管理就是投资者的盾
在这个市场中，有形形色色的人，有“开着坦克，行动缓慢”的大金融机构，遇到他们，投资者的优势就是灵活机动性，
这个时候就不要拿着“矛”去乱捅了,也不要期望自己的盾有多坚固，避开他们就是胜利。战场上有很多裸奔的人，而且人数众多，
我们的主要目标就是这些人，战胜他们，就是战胜了市场，但很多时候市场中也会发生很多大规模性的灾难，它们的发起者不是某个
具体的市场参与者，而是整个市场(天灾)，只要在这个市场中，就会受到牵连，所以要时时刻刻准备好自己的盾，避免系统性的灾难，
这是盾的主要职责，所以一定要重视仓位管理，它是让人能安心使用交易策略的基础
"""
'#######################################################################################################################'
"""
一只股票的时间简史
在很久很久以前，有一个国家，整个国家只有一只股票，开始的时候该股票的走势完全服从下面的描述：
    ...
    2、它的涨跌与只与前一天的涨跌相关，如果前一天是上涨的，那么今天仍然是涨的，如果前一天是下跌的，那么今天就是跌的(马尔代夫假设)
"""
